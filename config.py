...
BLM_DATA_PATH = DATA_DIRs_NAMES['blm_data']
...
PICKLE_BLM_INTERVALS_PATH = os.path.join(DATA_DIRs_NAMES['pickles'], 'analysed_blm')
BLM_INTERVALS_PLOTS_PATH = PICKLE_BLM_INTERVALS_PATH