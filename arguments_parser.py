...
def build_blm_dose_calc_parser():
    ...
    blm_csv_list_filename = '151617L2_ti_qi_ei_bi.csv' # 'all_blms_dcum_meters_ti_qi_ei_bi.csv'

    parser = argparse.ArgumentParser(description='BLM doses calculator')

    parser.add_argument("-s", "--start_date", help="provide start date of analysed period", type=parse, default=start)
    parser.add_argument("-e", "--end_date", help="provide end date of analysed period", type=parse, default=end)
