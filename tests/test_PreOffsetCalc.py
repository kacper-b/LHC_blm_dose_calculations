...
not_enough_space_before_enough_after = MagicMock(start=0.5, end=2.5, offset_pre=None, offset_pre_expected=35.5)
enough_space_before = MagicMock(start=4.6, end=5.5, offset_pre=None, offset_pre_expected=35.5)
nan_before_not_enough_after = MagicMock(start=7.5, end=9.5, offset_pre=None, offset_pre_expected=35.5)
not_enough_space_before_not_enough_after_because_of_intervals = MagicMock(start=9.6, end=10, offset_pre=None, offset_pre_expected=35.5)
not_enough_space_before_because_of_interval_enough_after = MagicMock(start=10.5, end=11.5, offset_pre=None, offset_pre_expected=125.5)
