...
not_enough_space_before_enough_after = MagicMock(start=0.5, end=2.5, offset_post=None, offset_post_expected=35.5)
enough_space_before = MagicMock(start=4.6, end=5.6, offset_post=None, offset_post_expected=35.5)
nan_before_not_enough_after = MagicMock(start=7.5, end=9.5, offset_post=None, offset_post_expected=0)
not_enough_space_before_not_enough_after_because_of_intervals = MagicMock(start=9.6, end=10, offset_post=None, offset_post_expected=0)
not_enough_space_before_because_of_interval_enough_after = MagicMock(start=10.5, end=11.5, offset_post=None, offset_post_expected=0)
not_enough_space_before_not_enough_after = MagicMock(start=13.4, end=14.5, offset_post=None, offset_post_expected=0)
...
post_offset_calc = PostOffsetCalc(2, 0)
