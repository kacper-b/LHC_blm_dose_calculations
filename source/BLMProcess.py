...
class BLMProcess:
    ...
    def run(self, blm_scratch):
        ...
        try:
            ...
            all_already_calculated_intervals = None
            ...
            if is_any_already_calculated_blm_exists:
                ...
                if not missing_blm_intervals:
                    all_already_calculated_intervals = loaded_blm_intervals
                    blm_scratch.blm_intervals = self.get_only_needed_blm_intervals(blm_scratch, all_already_calculated_intervals)
            ...
            self.update_pickled_blm(blm_scratch, all_already_calculated_intervals, calculated_blm_loader.file_paths)
